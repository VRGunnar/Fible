...
@section('content')
    <div class="w-4/5 m-auto mb-4 mt-20">
        ...
        <input class="inline text-xs p-2 float-right w-10/12 mx-2 rounded-3xl pl-4 ml-0" type="text" placeholder="Search for discounts" >
        <svg class="w-5 h-5 absolute right-16 top-20 stroke-0 mt-1.5" xmlns="http://www.w3.org/2000/svg" width="20.591" height="20.496" viewBox="0 0 20.591 20.496">
