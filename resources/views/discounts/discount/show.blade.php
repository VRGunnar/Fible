...
@section('content')
        ...
        <img class="w-5/5 h-64 object-cover mt-3 mb-14 bg-white sm:w-11/12 sm:m-auto sm:mb-20 sm:mt-3 sm:max-w-2xl" src="{{$discount->logo}}" alt="image">
...
<script src="{{ asset('/js/components/share.js') }}"></script>
@endsection