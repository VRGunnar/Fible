...
<div class="pb-20 bg-fWhite">
    <div class="text-sm w-4/5 m-auto flex justify-center mb-4 drop-shadow-[0_3px_6px_rgba(0,0,0,0.16)] mb-4 mt-10">
        <button class="btn-active inline bg-white py-2 px-2 rounded-l-2xl pl-4 choice transition-btn sm:px-14" data-for-tab="discounts">Kortingen</button>
        <button class="inline bg-white py-2 px-2 choice transition-btn sm:px-12" data-for-tab="subscriptions">Abonnementen</button>
        <button class="inline bg-white py-2 px-2 pr-4 rounded-r-2xl choice transition-btn sm:px-12" data-for-tab="favourites">Favorieten</button>
    </div>
    ...
    <div class="hidden tab" data-tab="favourites">
        ...
        <div class="bg-fWhite relative">
            ...
            <svg class="absolute top-2 right-2 w-5 h-5 {{ $f->fill }}" id="heart_icon" data-name="discount_favourite" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 471.7 420.29"><defs></defs><path d="M433.6,38.5a130.61,130.61,0,0,0-184.7.1L236,51.5,222.9,38.4a130.49,130.49,0,0,0-184.7-.2,130.49,130.49,0,0,0,.2,184.7L226.2,410.7l.19.17,9.46,9.42,13.08-13.2L433.4,223.3a129.82,129.82,0,0,0,38.3-92.38v0A129.21,129.21,0,0,0,433.6,38.5Z"/></svg>  
