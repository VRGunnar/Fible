...
@section('content')
        <svg class="ml-6 mt-3" xmlns="http://www.w3.org/2000/svg" width="12.838" height="12.512" viewBox="0 0 12.838 12.512" onClick="history.go(-1)">
        ...
        <img class="w-5/5 h-64 object-cover mt-3 mb-24 bg-white" src="{{$subscription->logo}}" alt="image">
        <div class="bg-fWhite rounded-tr-[60px] relative h-11/12">
            <div class="w-9/12 m-auto">
                <svg class="absolute right-16 top-8 w-5 h-5 ml-4 inline stroke-2 stroke-fGreyApp" id="heart_icon" data-name="discount_favourite" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 471.7 420.29"><defs><style>.cls-1{fill:#ffffff;}</style></defs><path class="fill-fRed" d="M433.6,38.5a130.61,130.61,0,0,0-184.7.1L236,51.5,222.9,38.4a130.49,130.49,0,0,0-184.7-.2,130.49,130.49,0,0,0,.2,184.7L226.2,410.7l.19.17,9.46,9.42,13.08-13.2L433.4,223.3a129.82,129.82,0,0,0,38.3-92.38v0A129.21,129.21,0,0,0,433.6,38.5Z"/></svg>
                ...
                <h1 class="text-2xl text-fBlack mt-6 mb-10 w-10/12">{{ $subscription->title }}</h1>
                <p class="text-sm mb-52">{{ $subscription->description }}</p>
