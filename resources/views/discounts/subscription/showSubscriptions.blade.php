...
@section('content')
        ...
        <img class="w-5/5 h-64 object-cover mt-3 mb-24 bg-white sm:w-11/12 sm:m-auto sm:mb-20 sm:mt-3 sm:max-w-2xl" src="{{$subscription->logo}}" alt="image">
        <div class="bg-fWhite rounded-tr-[60px] relative h-11/12">
            <div class=" w-9/12 m-auto max-w-xl">
                ...
                <p class=" text-sm mb-20">{{ $subscription->description }}</p>
