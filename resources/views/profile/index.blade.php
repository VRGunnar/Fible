        ...
        <div class="cardInner w-full h-full">
            <div class="cardFace w-full h-full front bg-gradient-to-br from-black to-fGrey rounded-xl p-4 drop-shadow-xl grid grid-cols-2 grid-rows-2 max-w-sm m-auto">
                ...
                <div class="col-start-1 col-end-3 row-start-2 row-end-3 flex flex-row justify-between">
                    ...
                    <svg class="w-20 h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95.05 106.38">
                        <defs>
                            <style>
                                .uuid-a3703663-07da-41b0-a5ea-9af3fe8c2e35 {
                                    fill: #f5f5f4;
                                }
                            </style>
                        </defs>
                        <path class="uuid-a3703663-07da-41b0-a5ea-9af3fe8c2e35" d="M47.62,62.82c13.96,0,25.29-11.6,25.29-25.9s-11.33-25.9-25.29-25.9-25.29,11.6-25.29,25.9,11.33,25.9,25.29,25.9Z" />
                        <path class="uuid-a3703663-07da-41b0-a5ea-9af3fe8c2e35" d="M85.05,0H10C4.5,0,0,4.5,0,10V96.38c0,5.5,4.5,10,10,10H85.05c5.5,0,10-4.5,10-10V10c0-5.5-4.5-10-10-10ZM10,3H85.05c3.86,0,7,3.14,7,7V86.68c-2.2-10.35-11.19-18.1-21.96-18.1h-9.67c-8.08,3.84-17.52,3.84-25.6,0h-9.67c-11.11,0-20.32,8.24-22.15,19.07V10c0-3.86,3.14-7,7-7Z" />
                    </svg>
                </div>
            </div>
            <div class="cardFace w-full h-full back bg-gradient-to-br from-black to-fGrey rounded-xl text-fWhite p-4 drop-shadow-xl flex flex-col gap-y-2 text-xs font-normal">
                ...
                <div class="flex flex-row justify-between">
                    ...
                    <svg class="w-24" viewBox="0 0 170.08 72.28">
                        <defs>
                            <style>
                                .uuid-694e5ccc-8691-4326-82fb-901db9d680fd {
                                    fill: #fff;
                                }

                                .uuid-4d7fda1b-68b8-4a8e-ae7d-821cf8a57d14 {
                                    fill: #1b4075;
                                }

                                .uuid-29a046e0-857c-4ff2-8f81-5e43e42825cb {
                                    fill: #67beeb;
                                }
                            </style>
                        </defs>
                        <rect class="uuid-29a046e0-857c-4ff2-8f81-5e43e42825cb" width="170.08" height="35.43" />
                        <g>
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M14.55,8.98h5.25l6.35,17.44h-5.57l-.73-2.49h-5.54l-.78,2.49h-5.4L14.55,8.98Zm4.23,11.21l-1.56-5.37h-.05l-1.69,5.37h3.3Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M31.62,20.56c0,.44,.07,.83,.2,1.15,.39,1.05,1.56,1.27,2.56,1.27,.88,0,2.22-.29,2.22-1.59,0-.9-.76-1.15-3.76-2-2.76-.78-5.91-1.54-5.91-5.06,0-4.03,3.44-5.76,7.03-5.76,3.79,0,7.13,1.44,7.28,5.69h-5.08c.1-.66-.2-1.1-.63-1.39-.44-.32-1.05-.44-1.59-.44-.73,0-1.93,.2-1.93,1.17,.1,1.25,2.59,1.51,5.06,2.2,2.47,.68,4.91,1.83,4.91,5.03,0,4.54-4.18,6.01-8.06,6.01-1.98,0-7.62-.71-7.67-6.28h5.37Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M47.91,20.56c0,.44,.07,.83,.2,1.15,.39,1.05,1.56,1.27,2.56,1.27,.88,0,2.22-.29,2.22-1.59,0-.9-.76-1.15-3.76-2-2.76-.78-5.91-1.54-5.91-5.06,0-4.03,3.44-5.76,7.03-5.76,3.79,0,7.13,1.44,7.28,5.69h-5.08c.1-.66-.2-1.1-.64-1.39-.44-.32-1.05-.44-1.59-.44-.73,0-1.93,.2-1.93,1.17,.1,1.25,2.59,1.51,5.06,2.2,2.47,.68,4.91,1.83,4.91,5.03,0,4.54-4.18,6.01-8.06,6.01-1.98,0-7.62-.71-7.67-6.28h5.37Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M68.26,8.57c5.3,0,8.84,3.81,8.84,9.13s-3.54,9.13-8.84,9.13-8.84-3.81-8.84-9.13,3.54-9.13,8.84-9.13Zm0,13.92c1.37,0,3.47-.9,3.47-4.79s-2.1-4.79-3.47-4.79-3.47,.9-3.47,4.79,2.1,4.79,3.47,4.79Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M90.36,15.48c-.1-.63-.59-2.56-2.81-2.56-2.52,0-3.32,2.44-3.32,4.79s.81,4.79,3.32,4.79c1.81,0,2.52-1.27,2.83-2.91h5.28c0,3.52-2.86,7.25-7.96,7.25-5.64,0-8.84-3.98-8.84-9.13,0-5.5,3.47-9.13,8.84-9.13,4.79,.02,7.43,2.54,7.89,6.91h-5.23Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M97.91,8.98h5.37V26.42h-5.37V8.98Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M110.87,8.98h5.25l6.35,17.44h-5.57l-.73-2.49h-5.54l-.78,2.49h-5.4l6.42-17.44Zm4.23,11.21l-1.56-5.37h-.05l-1.69,5.37h3.3Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M126.09,13.45h-4.88v-4.47h15.14v4.47h-4.88v12.97h-5.37V13.45Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M138.33,8.98h5.37V26.42h-5.37V8.98Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M146.46,8.98h14.43v4.47h-9.06v2.17h8.23v4.15h-8.23v2.17h9.33v4.47h-14.7V8.98Z" />
                        </g>
                        <rect class="uuid-4d7fda1b-68b8-4a8e-ae7d-821cf8a57d14" y="36.85" width="170.08" height="35.43" />
                        <rect class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" y="35.43" width="170.08" height="1.42" />
                        <g>
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M8.13,45.89h5.4v6.04h.05l4.81-6.04h6.65l-6.36,6.85,7.39,10.68h-6.73l-4.32-6.83-1.5,1.64v5.18h-5.4v-17.53Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M43.85,56.65c0,4.86-2.63,7.19-7.98,7.19s-8-2.33-8-7.19v-10.76h5.4v9.55c0,1.79,0,4.03,2.63,4.03s2.55-2.24,2.55-4.03v-9.55h5.4v10.76Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M56.49,45.89h5.4v13.04h7.76v4.49h-13.16v-17.53Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M72.81,45.89h14.51v4.49h-9.11v2.19h8.27v4.17h-8.27v2.19h9.38v4.49h-14.78v-17.53Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M106.86,56.65c0,4.86-2.63,7.19-7.98,7.19s-8-2.33-8-7.19v-10.76h5.4v9.55c0,1.79,0,4.03,2.63,4.03s2.55-2.24,2.55-4.03v-9.55h5.4v10.76Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M119.9,63.42h-6.04l-5.23-17.53h5.45l2.87,10.63h.05l2.82-10.63h5.55l-5.48,17.53Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M127.21,45.89h14.51v4.49h-9.11v2.19h8.27v4.17h-8.27v2.19h9.38v4.49h-14.78v-17.53Z" />
                            <path class="uuid-694e5ccc-8691-4326-82fb-901db9d680fd" d="M145.38,45.89h5.53l5.11,9.38h.05v-9.38h5.11v17.53h-5.25l-5.38-9.58h-.05v9.58h-5.11v-17.53Z" />
                        </g>
                    </svg>
                </div>
            </div>
            ...
            <svg class="w-14 h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43 23">
                <defs>
                    <style>
                        ...
                        .uuid-8cf2d64e-2461-4a1f-a1d1-6e33e0426d71 {
                            fill: #2dc692;
                        }
                    </style>
                </defs>
                <path id="uuid-56bedc15-8202-4d0f-84ba-81cf3334400f" class="uuid-8cf2d64e-2461-4a1f-a1d1-6e33e0426d71" d="M10.5,1H31.5c5.8,0,10.5,4.7,10.5,10.5h0c0,5.8-4.7,10.5-10.5,10.5H10.5C4.7,22,0,17.3,0,11.5H0C0,5.7,4.7,1,10.5,1Z" />
                <g transform="matrix(1, 0, 0, 1, 0, 0)">
                    <path id="uuid-bc7b99d0-b025-4674-ab16-578eb6c9a90e" class="uuid-90674127-0958-4e76-b2c7-1c4f52c08ce2" d="M30.5,0h1c6.35,0,11.5,5.15,11.5,11.5h0c0,6.35-5.15,11.5-11.5,11.5h-1c-6.35,0-11.5-5.15-11.5-11.5h0C19,5.15,24.15,0,30.5,0Z" />
                </g>
            </svg>
        </div>
